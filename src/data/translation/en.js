export default {
  AFunNewWayToLearn: 'A fun new way to learn how to take better care of your teeth.',
  ThisWebsiteUsesCookiesTo: 'This website uses cookies to improve user experience. By using our website you consent to all cookies in accordance with our <a href="/terms"> Cookie Policy </a>',
  GetStarted: 'Get Started',
  SelectCoach: 'Select Coach',
  AgeGroup: 'Age Group',
  Iam8or: 'I am 8 or younger',
  Iam9or: 'I am 9 or older',
  Congratulations: 'Congratulations!',
  YouunlockedBadge: 'You unlocked a new badge!',
  points: 'points',
  ProfileCompleted: 'Profile Completed',
  cavityMonsterHero: 'Cavity Monster Hero',
  FightingCavities: 'Fighting Cavities',
  BrushSelfie: 'Brush Selfie',
  becareful: "be careful, cavity monsters may be there!",
  BrushTimer: 'Brush Timer',
  BabyTeeth: 'Baby Teeth',
  BrushingandFlossing: 'Brushing and Flossing',
  BeforeBaby: 'Before Baby',
  CavityMath: 'Cavity Math',
  HealthyFoodsandTeeth: 'Healthy Foods and Teeth',
  BrushingSelfie: 'Brushing Selfie',
  TheAchiever: 'The Achiever',
  Sugar: 'Sugar',
  Memory: 'Memory',
  Matching:'Matching',
  Whatinsideourmouths: 'What’s inside our mouths?',
  CavityMath: 'Cavity Math',
  Whichsnacksdomyteethlove: 'Which snacks do my teeth love?',
  IKnowMyTeeth: 'I Know My Teeth',
  BrushingSelfie: 'Brushing Selfie',
  CompleteTopic: 'Complete topic',
  CompletingProfile: 'Completing Profile',
  CompletingCavityPrevention: 'Completing Cavity Prevention',
  CompletingBabyTeeth: 'Completing Baby Teeth',
  TakeAelfie: 'Take a selfie',
  Loggedineverydayforamonth: 'Logged in everyday for a month',
  Topics: 'Topics',
  BrushTimer: 'Brush Timer',
  Profile: 'Profile',
  About: 'About',
  ...
  PlayNext: 'Play Next',
  YeahYourefightingmonsters: 'Yeah! <br/>You’re fighting<br/>the cavity monsters!',
  CavityMonsters: 'Cavity Monsters',
  UhThecavitymonstersArecoming: 'Uh-oh! <br />The cavity monsters <br /> are coming!',
  Tryagain: 'Try again',
  Areyouureyouwantleave: 'Are you sure you <br/>want to leave?',
  yes: 'yes',
  no: 'no',
  General: 'General',
  ...
  Pleaseenterthecode: 'Please enter the code provider by your care giver',
  code: 'code',
  Enter: 'Enter',
  password: 'password',
  email: 'email',
  Forgot: 'Forgot',
  GoodJob: 'Good Job!',
  Youcompletedamodule: 'You completed a module.',
  Topics: 'Topics',
  Continue: 'Continue',
  MyDentalOffice: 'My Dental Office',
  Learnhowtostop: 'Learn how to stop the cavity monsters!',
  Swipeuptoseecoursecontents: 'Swipe up to see course contents',
  NextUp: 'Next Up',
  Wereworkingonit: "We're working on it!",
  Aсhievements: 'Aсhievements',
  View: 'View',
  LockedBadge: 'Locked Badge',
  Unlocktoseethedetails: 'Unlock to see the details',
...
<p>Visit us online at <a href="https://dentistry.uic.edu/">dentistry.uic.edu</a>.</p>`,
  CavityPrevention: 'Cavity Prevention',
  Whatinsideyourmouth: 'What’s inside your mouth?',
  Wheredocavities: 'Where do cavities come from?',
  Sugaryfoods: 'Sugary foods',
  Goingtothezoo: 'Going to the zoo',
  Readingabook: 'Reading a book',
  Dancing: 'Dancing',
  Sugarydrinks: 'Sugary drinks',
  Howtostopthecavitymonsters: 'How to stop the cavity monsters.',
  Brushingawaythecavitymonsters: 'Brushing away the cavity monsters!',
  CavityMathinstructions: 'Cavity Math instructions.',
  Howdowestopthecavitymonsters: 'How do we stop the cavity monsters?',
  Neverbrushmyteeth: 'Never brush my teeth',
  Brushtwiceaday: 'Brush twice a day',
  Waituntiltomorrow: 'Wait until tomorrow',
  Brushafterasnack: 'Brush after a snack',
  Brushfor2minutes: 'Brush for 2 minutes',
  Brushfor1minute: 'Brush for 1 minute',
  Brushonceaday: 'Brush once a day',
  Whatsnacksdomyteethlove: 'What snacks do my teeth love?',
  Goodformeorgoodforcavity: 'Good for me or good for cavity monsters?',
  Clicktofindout: 'Click to find out.',
  Apple: 'Apple',
  Goodforme: 'Good for me!',
  Carrots: 'Carrots',
  Candy: 'Candy',
  CavityMonster: 'Cavity Monster!',
  Peanuts: 'Peanuts',
  Chips: 'Chips',
  IceCream: 'Ice Cream',
  Milk: 'Milk',
  ...
  Soda: 'Soda',
  Juice: 'Juice',
  SweetenedDrinks: 'Sweetened Drinks',
  Letslearnsomecavitymath: 'Let\'s learn some cavity math!',
  Brushingtwiceaday: 'Brushing twice a day',
  Healthysnacks: 'Healthy snacks',
  Sugarysnacks: 'Sugary snacks',
  Notbrushing: 'Not brushing',
  Brushingaftereachmeal: 'Brushing after each meal',
  Dragthefoodsto: 'Drag the foods to the mouth to find the answer.',
  brush: 'brush',
  donut: 'donut',
  chocolate: 'chocolate',
  water :'water',
  ...
  grapes: 'grapes',
  icecream: 'ice-cream',
  Trulyamazingcourse: 'Truly amazing course! I learned a lot of things about medicine in the shortestamount of time :)',
  ...
  audio_first_question_for_icons: 'first_question_for_icons',
  audio_icons_select_wrong: 'icons_select_wrong',
  audio_icons_select_correct: 'icons_select_correct',
  audio_first_question_for_cards: 'first_question_for_cards',
  audio_first_question_for_calc: 'first_question_for_calc',
  audio_good_job: 'good_job',
  audio_unlocked_badge: 'unlocked_badge',
  ...
  BabyTeethThingTeethFor: 'Which of these things do you need teeth for?',
  talking:'Talking',
  eating:'Eating',
  kickingBall:'Kicking a Ball',
  smiling: 'Smiling',
  singing: 'Singing',
  wearingHat:'Wearing a Hat',
  chewingFood: 'Chewing Food',
  huggingCrocodile: 'Hugging a Crocodile',
  whyNeedTeeth:'Why do we need teeth?',
  chantFull:'THIRTY-THREE THIRSTY THIEVES!',
  chant1:'THIRTY',
  chant2: 'THREE',
  chant3: 'THIRSTY',
  chant4: 'THIEVES',
  babyTeeth:'Baby Teeth',
  babyTeething:'Baby Teething',
  brushingBabyTeeth:'Brushing Baby Teeth',
  readyToTime:'Ready to time your brushing?',
