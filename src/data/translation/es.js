export default {
  AFunNewWayToLearn: 'Una forma nueva y divertida de aprender como cuidar tus dientes',
  ThisWebsiteUsesCookiesTo: 'Este sitio web utiliza cookies para mejorar la experiencia del usuario. Al utilizar nuestro sitio web, usted acepta todas las cookies de acuerdo con nuestra <a href="/terms"> Política de Cookies </a>',
  GetStarted: 'Empezar',
  SelectCoach: 'Seleciona un entrenador',
  AgeGroup: 'Grupo de edad',
  Iam8or: 'Tengo 8 años o menos',
  Iam9or: 'Tengo 9 años o más',
  Congratulations: '¡Felicitaciones!',
  YouunlockedBadge: '¡Has desbloqueado una nueva insignia!',
  points: 'puntos',
  ProfileCompleted: 'Perfil Completado',
  cavityMonsterHero: 'Heroe de los monstruos de la caries',
  FightingCavities: 'Luchando contra la caries',
  BrushSelfie: 'Selfie de cepillado',
  BrushTimer: 'Temporizador de cepillado',
  BabyTeeth: 'Dientes de bebé',
  BrushingandFlossing: 'Cepillado y ceda dental',
  BeforeBaby: 'Antes del bebé',
  CavityMath: 'Matemáticas de la caries',
  HealthyFoodsandTeeth: 'Comida y dientes sanos',
  IKnowMyTeeth: 'Conozco mis dientes',
  BrushingSelfie: 'Cepillado Selfie',
  TheAchiever: 'El triunfador',
  becareful: "be careful, cavity monsters may be there!",
  Sugar: 'Azucar',
  Memory: 'Memoria',
  Matching:'Emparejar',
  Whatinsideourmouths: '¿Qué hay dentro de nuestras bocas?',
  CavityMath: 'Matemáticas de la cavidad',
  ...
  TakeAelfie: 'Toma una selfie',
  Loggedineverydayforamonth: 'Registrado todos los días por un mes',
  Topics: 'Temas',
  BrushTimer: 'Temporizador de cepillado',
  Profile: 'Perfil',
  About: 'Acerca de',
  HappyMouth: 'Boca feliz',
  PlayNext: 'Jugar siguiente',
  YeahYourefightingmonsters: '¡Si! <br/>Estas luchando contra<br/>los monstruos de la caries!',
  CavityMonsters: 'Monstruos de la caries',
  UhThecavitymonstersArecoming: '¡Oh oh! <br />vienen <br /> los mostruos de la caries',
  Tryagain: 'Inténtalo de nuevo',
  Areyouureyouwantleave: '¿Estas seguro<br/>de querer irte? ES',
  yes: 'si',
  no: 'no',
  General: 'General',
  ...
  Achievements: 'Logros',
  Settings: 'Ajustes',
  EditLoginDetails: 'Editar detalles de acceso',
  UpdateInterests: 'Actualizar intereses',
  BlockedUsers: 'Usuarios bloqueados',
  UniversitySchoolofDentistry: 'Facultad de Odontología de la Universidad de Illinois',
  CONTACT: 'CONTACTO',
  ChicagoIL60612: '801 S Paulina St, Chicago, IL 60612',
  Website: 'Sitio Web',
  EnterCode: 'Ingresa el código',
  Pleaseenterthecode: 'Por favor ingresa el código provisto por tu cuidador',
  code: 'código',
  Enter: 'Entrar',
  password: 'Contraseña',
  email: 'email',
  ...
  Youcompletedamodule: 'Completaste un módulo',
  Topics: 'Temas',
  Continue: 'Continuar',
  MyDentalOffice: 'My oficina dental',
  Learnhowtostop: 'Aprende como detener a los monstruos de la caries',
  Swipeuptoseecoursecontents: 'Desliza hacia arriba para ver los contenidos del curso',
  NextUp: 'Siguiente',
  Wereworkingonit: "¡Estamos trabajando en ello!",
  Aсhievements: 'Logros',
  View: 'Vista',
  LockedBadge: 'Insignia bloqueada',
  Unlocktoseethedetails: 'Desbloquea para ver los detalles',
  AboutPage: `<h1>Acerca de</h1>
<p>¡Bienvenido a Healthy Starts, una nueva y divertida forma de aprender cómo tener un cuidado excelente de tus dientes!</p>
<h4>Qué es Healthy Starts?</h4>
<p>Healthy Starts una nueva e innovadora experiencia de aprendizaje interactiva para los niños y sus padres, para aprender por qué es tan importante cuidar sus dientes, cómo hacerlo bien y compartir sus logros con amigos. Pensamos en esto como una especie de fitbit para el cuidado dental.</p>
<h4>How do I gets started?</h4>
<p>First, choose your age group, coach and dental team. Then, you can choose a topic or play the one assigned by your dentist. As you play, your progress is tracked and you will earn points and badges! Check out your profile page to see your progress. The games can be played on a desktop computer, or any mobile device of your choice. Some of the games are best played while you’re brushing your teeth in the bathroom, so we recommend using a smartphone or tablet.</p>
...
<p>Visit us online at <a href="https://dentistry.uic.edu/">dentistry.uic.edu</a>.</p> ES`,
  CavityPrevention: 'Prevención de caries',
  Whatinsideyourmouth: '¿Qué hay al interior de tu boca?',
  Wheredocavities: '¿De donde provienen las caries?',
  Sugaryfoods: 'Alimentos azucarados',
  Goingtothezoo: 'Yendo al zoologico',
  Readingabook: 'Leyendo un libro',
  Dancing: 'Bailando',
...
  <p> Contáctanos </p>
  ...
  audio_babyteeth_module3_audio: 'babyteeth_module3_audio_esp',
  thats_right_for_children_under_three_audio: 'thats_right_for_children_under_three_audio_esp',
  remember_for_children_under_three_audio: 'remember_for_children_under_three_audio_esp',
  thats_right_for_children_three_to_six_audio: 'thats_right_for_children_three_to_six_audio_esp',
  thats_right_fluoride_audio: 'thats_right_fluoride_audio_esp',
  remember_for_children_three_to_six_audio: 'remember_for_children_three_to_six_audio_esp',
  remember_fluoride_audio: 'remember_fluoride_audio_esp',
  video1: 'module1_spanish.mp4',
  video1b: 'module1b_spanish.mp4',
  video2: 'module1_spanish.mp4',
  video2b: 'module1b_spanish.mp4',
  ...
  babyteethvideo4: 'baby-teeth_module4-esp.mp4',
  ...
  BabyTeethThingTeethFor: '¿Para cuál de estas cosas necesitas dientes?',
  talking:'Hablando',
  eating:'Comiendo',
  kickingBall:'Pateando una pelota',
  smiling: 'Sonriente',
  singing: 'Canto',
  wearingHat:'Luciendo un sombrero',
  chewingFood: 'Masticar comida',
  huggingCrocodile: 'Abrazando un cocodrilo',
  whyNeedTeeth:'¿Por qué necesitamos dientes?',
  chantFull:'TREINTA Y TRES TENIENTES SEDENTES!',
  chant1:'TREINTA',
  chant2: 'TRES',
  chant3: 'SEDIENTA',
  chant4: 'LADRONAS',
  babyTeeth:'Dientes de bebé',
  babyTeething:'Dentición del bebé',
  brushingBabyTeeth:'Cepillarse los dientes de leche',
  readyToTime:'¿Listo para cronometrar tu cepillado?',
  ...
  HowMuchToothPasteChild: '¿Cuánta pasta dental para niños de 3 a 6 años?',
  ShouldIUseFluoride: '¿Debo usar pasta de dientes sin flúor?',
  YesFluoride: 'Sí, porque el fluoruro sabe mal',
  NoFluoride: 'No, el fluoruro ayuda a prevenir las caries',
}
